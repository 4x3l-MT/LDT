const EclaireButton = document.getElementById("Eclaire");
const contEclaire = document.getElementById("contEclaire");

const FroyoButton = document.getElementById("Froyo");
const contFroyo = document.getElementById("contFroyo");

const GingerbreadButton = document.getElementById("Gingerbread");
const contGingerbread = document.getElementById("contGingerbread");

const HoneycombButton = document.getElementById("Honeycomb");
const contHoneycomb = document.getElementById("contHoneycomb");

const IceCreamSandwichButton = document.getElementById("IceCreamSandwich");
const contIceCreamSandwich = document.getElementById("contIceCreamSandwich");

const JellyBeanButton = document.getElementById("JellyBean");
const contJellyBean = document.getElementById("contJellyBean");

const KitkatButton = document.getElementById("Kitkat");
const contKitkat = document.getElementById("contKitkat");

const LollipopButton = document.getElementById("Lollipop");
const contLollipop = document.getElementById("contLollipop");
...
FroyoButton.addEventListener("click", () => {
    if (contFroyo) {
    contFroyo.scrollIntoView({ behavior: 'smooth' }); 
  }
});

GingerbreadButton.addEventListener("click", () => {
    if (contGingerbread) {
    contGingerbread.scrollIntoView({ behavior: 'smooth' }); 
  }
});

HoneycombButton.addEventListener("click", () => {
    if (contHoneycomb) {
    contHoneycomb.scrollIntoView({ behavior: 'smooth' }); 
  }
});

IceCreamSandwichButton.addEventListener("click", () => {
    if (contIceCreamSandwich) {
    contIceCreamSandwich.scrollIntoView({ behavior: 'smooth' }); 
  }
});

JellyBeanButton.addEventListener("click", () => {
    if (contJellyBean) {
    contJellyBean.scrollIntoView({ behavior: 'smooth' }); 
  }
});

KitkatButton.addEventListener("click", () => {
    if (contKitkat) {
    contKitkat.scrollIntoView({ behavior: 'smooth' }); 
  }
});

LollipopButton.addEventListener("click", () => {
    if (contLollipop) {
    contLollipop.scrollIntoView({ behavior: 'smooth' }); 
  }
});

MarshmallowButton.addEventListener("click", () => {
    if (contMarshmallow) {
